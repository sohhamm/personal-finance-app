...
router.get('/:id', uuidValidation, handleValidationErrors, TransactionController.getTransactionById);
router.post('/', createTransactionValidation, handleValidationErrors, TransactionController.createTransaction);
router.put('/:id', uuidValidation, updateTransactionValidation, handleValidationErrors, TransactionController.updateTransaction);
router.delete('/:id', uuidValidation, handleValidationErrors, TransactionController.deleteTransaction);
