...
import { sql, RecurringBill, RecurringBillPayment } from '@/db/index';
import { ResponseUtils } from '@/utils/response';
import { Logger } from '@/utils/logger';

export class RecurringBillController {
  static async getRecurringBills(req: Request, res: Response) {
    try {
      ...
      Logger.error('Error getting recurring bills:', error);
      return ResponseUtils.serverError(res);
    }
  }

  static async getRecurringBillById(req: Request, res: Response) {
    try {
      const userId = req.user!.id;
      const { id } = req.params;
      ...
      Logger.error('Error getting recurring bill by ID:', error);
      return ResponseUtils.serverError(res);
    }
  }

  static async createRecurringBill(req: Request, res: Response) {
    try {
      const userId = req.user!.id;
      ...
      Logger.error('Error creating recurring bill:', error);
      return ResponseUtils.serverError(res);
    }
  }

  static async updateRecurringBill(req: Request, res: Response) {
    try {
      const userId = req.user!.id;
      const { id } = req.params;
      ...
      Logger.error('Error updating recurring bill:', error);
      return ResponseUtils.serverError(res);
    }
  }

  static async deleteRecurringBill(req: Request, res: Response) {
    try {
      const userId = req.user!.id;
      const { id } = req.params;
      ...
      Logger.error('Error deleting recurring bill:', error);
      return ResponseUtils.serverError(res);
    }
  }
  ...
  static async getBillsDueSoon(req: Request, res: Response) {
    try {
      const userId = req.user!.id;
      ...
      Logger.error('Error getting bills due soon:', error);
      return ResponseUtils.serverError(res);
    }
  }
